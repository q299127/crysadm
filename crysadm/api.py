...
agent_header = {'user-agent': "RedCrystal/2.0.0 (iPhone; iOS 8.1.2; Scale/2.00)"}
...
# 获取WEB管理相关信息
def uweb_cd(session_id, account_id, device_id):
    url = "http://kj.xunlei.com/setting.html?user_id=%s&session_id=%s&device_id=%s" % (account_id, session_id, device_id)
    try:
        return url
